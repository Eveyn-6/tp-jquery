$('#couleur-fond').change(function() {
  ...
  $('#texte').change(function(){
    ...
    if (te == 'Souligné') $('#contenu p').css('text.decoration', 'underline')
    if (te == 'Normal'){
    $('#contenu p').css('font-weight', 'normal')
    $('#contenu p').css('font-style', 'normal') 
    $('#contenu p').css('font-weight', 'none')      
  }}) 
  ...
  $(function() {
    ...
    $('#bordure-images').change(function() {
      ...
      if (bi == 'Simple') $('img').css('border', '2px solid purple');
      if (bi == 'Double') $('img').css('border', '5px double purple');
    });         
